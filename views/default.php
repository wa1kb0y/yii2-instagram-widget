...
<div class="instagram-widget" id="<?php echo $widgetId ?>">
...
$css = <<<CSS
        ...
        .instagram-widget#{$widgetId} .title .text {
            float: left;
        ...
        #{$widgetId}.instagram-widget .data .image {
            display: block;
            float: left;
            margin: 0 5px 5px 0;
            width: {$imgWidth}px;
        ...
        #{$widgetId}.instagram-widget .data .image img {
            width: {$imgWidth}px;
        }
